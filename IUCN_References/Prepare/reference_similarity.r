...
references_sub$ID<-paste("label", c(1:nrow(references_sub)), sep="_")
...
View(references_sub[ID %in% c("label_10037", "label_9703")])
...
removed_labels<-references_sub[reference_container %in% container_removed | reference_title_clean %in% title_removed]$ID
