...
prompt_template_en <- read_file("/media/huijieqiao/WD22T_11/literatures/Data/CSC/prompt.txt")
system_instruction <- read_file("/media/huijieqiao/WD22T_11/literatures/Data/CSC/system_instruction.txt")
